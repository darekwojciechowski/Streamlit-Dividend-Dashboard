...
class DividendDataProcessor:
    ...
    def __init__(self, file_path: str):
        ...
        try:
            ...
            required_cols = ['Ticker', 'Net Dividend',
                             'Tax Collected', 'Shares']
            ...
            print(
                f"An error occurred during data processing initialization: {e}")
        ...
        for col, clean_func in cleaning_map.items():
            if col in self.df.columns:
                try:
                    ...
                    print(
                        f"Warning: Could not clean or convert column '{col}'. Error: {e}")
            else:
                print(
                    f"Warning: Expected column '{col}' not found for cleaning.")
